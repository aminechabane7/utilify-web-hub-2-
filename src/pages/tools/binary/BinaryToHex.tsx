...
// Binary to HEX Converter Component
const BinaryToHex: React.FC = () => {
  ...
  function binaryToHex(binary: string): string {
    return binary
      .split(" ")
      .map((bin) =>
        parseInt(bin, 2).toString(16).padStart(2, "0").toUpperCase()
      )
      .join(" ");
  }
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md mt-8">
      <h2 className="text-2xl font-bold mb-4 text-center">Binary to HEX</h2>
      <input
        type="text"
