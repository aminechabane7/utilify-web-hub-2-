...
// Binary to ASCII Converter Component
const BinaryToAscii: React.FC = () => {
  ...
  const handleConvert = () => {
    setOutput(binaryToAscii(input));
  };

  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md mt-8">
      <h2 className="text-2xl font-bold mb-4 text-center">Binary to ASCII</h2>
      <input
        type="text"
