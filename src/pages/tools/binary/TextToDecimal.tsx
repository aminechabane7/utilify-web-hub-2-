...
// Text to Decimal Converter Component
const TextToDecimal: React.FC = () => {
  ...
  const handleConvert = () => {
    setOutput(textToDecimal(input));
  };

  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md mt-8">
      <h2 className="text-2xl font-bold mb-4 text-center">Text to Decimal</h2>
      <input
        type="text"
