...
// Decimal to Octal Converter Component
const DecimalToOctal: React.FC = () => {
  ...
  const handleConvert = () => {
    setOutput(decimalToOctal(input));
  };

  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md mt-8">
      <h2 className="text-2xl font-bold mb-4 text-center">Decimal to Octal</h2>
      <input
        type="text"
